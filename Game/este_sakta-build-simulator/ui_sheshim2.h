/********************************************************************************
** Form generated from reading UI file 'sheshim2.ui'
**
...
#ifndef UI_SHESHIM2_H
#define UI_SHESHIM2_H
...
public:
    ...
    void setupUi(QMainWindow *sheshim2)
    {
        if (sheshim2->objectName().isEmpty())
            sheshim2->setObjectName(QString::fromUtf8("sheshim2"));
        sheshim2->resize(339, 420);
        sheshim2->setStyleSheet(QString::fromUtf8("border-image: url(:/bg_wewim);"));
        centralwidget = new QWidget(sheshim2);
        centralwidget->setObjectName(QString::fromUtf8("centralwidget"));
        gridLayout_2 = new QGridLayout(centralwidget);
        gridLayout_2->setObjectName(QString::fromUtf8("gridLayout_2"));
        verticalSpacer_3 = new QSpacerItem(120, 40, QSizePolicy::Minimum, QSizePolicy::Minimum);
...
"font: 75 28pt \"MS Shell Dlg 2\";"));
        ...
        verticalSpacer = new QSpacerItem(120, 20, QSizePolicy::Minimum, QSizePolicy::MinimumExpanding);
...
"border-image: url(:/e_b);"));
        ...
        verticalSpacer_2 = new QSpacerItem(120, 82, QSizePolicy::Minimum, QSizePolicy::Expanding);
...
"font: 75 24pt \"MS Shell Dlg 2\";"));
        ...
        sheshim2->setCentralWidget(centralwidget);

        retranslateUi(sheshim2);

        QMetaObject::connectSlotsByName(sheshim2);
    } // setupUi

    void retranslateUi(QMainWindow *sheshim2)
    {
        sheshim2->setWindowTitle(QApplication::translate("sheshim2", "MainWindow", 0, QApplication::UnicodeUTF8));
        label->setText(QString());
        pushButton_esep->setText(QString());
        pushButton_2->setText(QApplication::translate("sheshim2", "5", 0, QApplication::UnicodeUTF8));
        pushButton_3->setText(QApplication::translate("sheshim2", "5", 0, QApplication::UnicodeUTF8));
        pushButton_4->setText(QApplication::translate("sheshim2", "5", 0, QApplication::UnicodeUTF8));
        pushButton_5->setText(QApplication::translate("sheshim2", "5", 0, QApplication::UnicodeUTF8));
        pushButton_6->setText(QString());
        label_2->setText(QApplication::translate("sheshim2", "2", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class sheshim2: public Ui_sheshim2 {};
} // namespace Ui
